...
import { MANTLEABI, MANTLECONTRACTADDRESS } from "@/utils/contracts";
...
const WithdrawUI = () => {
  ...
  const handleWithdrawal = async () => {
    ...
    try {
      const withdrawContract = new Contract(MANTLECONTRACTADDRESS, MANTLEABI, signer);
      const res = await withdrawContract.withdrawMessage();
